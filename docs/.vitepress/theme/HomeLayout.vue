  ...
  <div class="custom-home-layout">
    <div class="hero-section">
      ...
      <div class="hero-actions">
        <a href="/cloud-pharmacy-docs/guide/getting-started" class="hero-button primary">快速上手 →</a>
        <a href="/cloud-pharmacy-docs/guide/getting-started#系统安装" class="hero-button secondary">安装</a>
      </div>
    </div>
  </div>
</template>

<template>
  <div class="custom-home-layout">
    <div class="hero-section">
      <h2 class="hero-subtitle gradient-text">药品管理系统</h2>
      <p class="hero-description">易用高效，专业可靠，适用场景丰富的药品管理与医疗信息平台。</p>
      
      <div class="hero-actions">
        <a href="/cloud-pharmacy-docs/guide/getting-started.html" class="hero-button primary">快速上手 →</a>
        <a href="/cloud-pharmacy-docs/guide/getting-started.html#系统安装" class="hero-button secondary">安装</a>
      </div>
    </div>
  </div>
</template>
...
.gradient-text {
  background: var(--custom-gradient-text, linear-gradient(120deg, #42d392 30%, #47c1ff));
